...
1. **Central Frame:**
   - Renders the current simulation frame data, providing a visual overview of the ongoing simulation.

2. **Unit State Viewer:**
   - Displays basic information: health, position, and status for each unit in the simulation.

3. **Unit Selection Feature:**
   - Highlights selected units, making it easier for users to identify and manage unit statuses during the simulation.
