...
#pragma warning restore CS0618
        ...
        _sheetsService = new SheetsService(new BaseClientService.Initializer
        {
            ...
            ApplicationName = "UnitSimulator Google Sheets to XML Converter"
        });
    }

    /// <summary>
    /// 환경 변수로부터 인증 정보를 읽어 GoogleSheetsService를 초기화합니다.
    /// </summary>
    public static GoogleSheetsService FromEnvironment()
    {
